...
public class Test1
{
	public static void main(String ... args)
	{
		try
		{
			...
			TextNodeItem slider1 = new SliderNodeItem("Roughness", 0, 1, 0);
			TextNodeItem slider2 = new SliderNodeItem("Roughness", 0, 1, 0.5);
			TextNodeItem slider3 = new SliderNodeItem("Roughness", 0, 1, 0.75);
			TextNodeItem slider4 = new SliderNodeItem("Roughness", 0.0, 0.1);
			TextNodeItem checkbox1 = new CheckBoxNodeItem("Inverted", false);
			TextNodeItem checkbox2 = new CheckBoxNodeItem("Inverted", true);
			TextNodeItem comboBoxNodeItem1 = new ComboBoxNodeItem("GCX");
			TextNodeItem comboBoxNodeItem2 = new ComboBoxNodeItem("Beckmann");
